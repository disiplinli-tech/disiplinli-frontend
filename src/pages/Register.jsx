...
import {
  BookOpen, Eye, EyeOff, User, Mail, Lock, Shield, X,
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-8 lg:px-12 xl:px-20">
        <div className="w-full max-w-[440px] mx-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-surface-500 mt-2 text-sm">Birkaç bilgi ile hemen başla.</p>
          </div>
          ...
          {/* Footer */}
          <p className="text-center text-surface-400 text-xs mt-8 pb-4">
