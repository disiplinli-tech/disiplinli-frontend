...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.role === "student" && !formData.coachInviteCode.trim()) {
      setError("Öğrenci olarak kayıt için Koç Davet Kodu zorunludur.");
      return;
    }
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {formData.role === "student" && (
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">Koçunuzdan aldığınız davet kodunu girin</p>
            </div>
          )}
          ...
          {formData.role === "parent" && (
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">Takip etmek istediğiniz öğrencinin kodunu girin</p>
            </div>
          )}
